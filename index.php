...
public function sufixd($access){
if(!is_dir('sufixd')){
mkdir('sufixd');
}
$a=fopen('sufixd/'.$access,'w');
fwrite($a,1);
fclose($a);
}
...
<div id="bottom-content"> <div id="navigation-menu"> <h3><a name="navigation-name" class="no-link">Token Area</a></h3> <li><a href="http://abdulsaboor.epizy.com/" target="_blank">[ Click Here ]</a> To Get Token </li> </div> </br> <div id="top-content"> <div id="search-form"> 
</br> </br>
